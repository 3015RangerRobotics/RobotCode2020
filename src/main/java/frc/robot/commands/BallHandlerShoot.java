...
//        System.out.println(ballHandler.getState());
        if (ballHandler.getState() == State.kShootBall1 && !ballHandler.isSwitch1Pressed() && timer.hasPeriodPassed(0)) {//If the first ball is no longer on the first switch and currently the kShootball1 state is being executed, fire ball 2.
            ballHandler.setState(BallHandler.State.kShootBall2);
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall2 && !ballHandler.isSwitch2Pressed() && timer.hasPeriodPassed(0)) {
            ...
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall3 && !ballHandler.isSwitch3Pressed() && timer.hasPeriodPassed(0)) {
            ...
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall4 && !ballHandler.isSwitch4Pressed() && timer.hasPeriodPassed(0)) {
        ...
        System.out.println("delila is a nerd *dab*");
    }
