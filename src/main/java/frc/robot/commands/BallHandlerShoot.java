...
public class BallHandlerShoot extends CommandBase {
    ...
    @Override
    public void execute() {
        if (ballHandler.getState() == State.kShootBall1Fast && !ballHandler.isSwitch1Pressed() && timer.hasElapsed(delay)) {
            ...
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall2Fast && !ballHandler.isSwitch2Pressed() && timer.hasElapsed(delay)) {
            ...
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall3Fast && !ballHandler.isSwitch3Pressed() && timer.hasElapsed(delay)) {
            ...
            timer.reset();
            timer.start();
        } else if (ballHandler.getState() == State.kShootBall4Fast && !ballHandler.isSwitch4Pressed() && timer.hasElapsed(delay)) {
    ...
    public boolean isFinished() {
        return ballHandler.getState() == State.kShootBall5Fast && timer.hasElapsed(0.5);
    }
}
