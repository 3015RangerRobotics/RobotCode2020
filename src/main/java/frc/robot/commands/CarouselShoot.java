...
public class CarouselShoot extends CommandBase {
    ...
    public void initialize() {
        ...
        RobotContainer.carousel.setState(Carousel.State.kShootBall1);//start by shooting first ball
    ...
    public void execute() {
        if (RobotContainer.carousel.getState() == State.kShootBall1 && !RobotContainer.carousel.isBall1Present() && timer.hasElapsed(delay)) {
            ...
            RobotContainer.carousel.setState(Carousel.State.kShootBall2);
            timer.reset();
            timer.start();
            ...
            RobotContainer.carousel.setState(Carousel.State.kShootBall3);
            timer.reset();
            timer.start();
            ...
            RobotContainer.carousel.setState(Carousel.State.kShootBall4);
            timer.reset();
            timer.start();
            ...
            RobotContainer.carousel.setState(Carousel.State.kShootBall5);
            timer.reset();
            timer.start();
        }
    }
